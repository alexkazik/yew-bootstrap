...
//! * Use [`BIFiles::cdn()`](crate::icons::BIFiles::cdn)
//! * Use [`BIFiles::copy()`](crate::icons::BIFiles::copy) - see below
//! * Access the data via [`BIFiles::FILES`](crate::icons::BIFiles::FILES) and deliver them yourself
//!
